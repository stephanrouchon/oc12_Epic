...
class TestUserService:
    ...
    def test_create_user_success(self, monkeypatch):
        ...
        monkeypatch.setattr(
            "services.user_services.utils.is_valid_email",
            mock_is_valid_email)
        monkeypatch.setattr(
            "services.user_services.get_current_user_info",
            mock_get_current_user_info)
        monkeypatch.setattr(
            "services.user_services.log_user_creation",
            mock_log_user_creation)
        ...
        with patch("database.dao.departement_dao.DepartementDAO") \
                as mock_dept_dao_class:
    ...
    def test_create_user_invalid_email(self, monkeypatch):
        ...
        monkeypatch.setattr(
            "services.user_services.utils.is_valid_email", mock_is_valid_email)
    ...
    def test_create_user_exception(self, monkeypatch):
        ...
        monkeypatch.setattr(
            ...
            mock_get_current_user_info)
        monkeypatch.setattr(
            "services.user_services.log_exception",
            mock_log_exception)
    ...
    def test_update_user_success(self, monkeypatch):
        ...
        monkeypatch.setattr(
            ...
            mock_get_current_user_info)
        monkeypatch.setattr(
            "services.user_services.log_user_update",
            mock_log_user_update)
    ...
    def test_update_user_exception(self, monkeypatch):
        ...
        monkeypatch.setattr(
            "services.user_services.log_exception", mock_log_exception)
    ...
    def test_update_user_valid_employee_number(self, monkeypatch):
        ...
        monkeypatch.setattr(
            ...
            mock_get_current_user_info)
        monkeypatch.setattr(
            "services.user_services.log_user_update", mock_log_user_update)
    ...
    def test_user_service_import(self):
        """Test pour forcer l'import du module
        user_services pour la couverture"""
        from services.user_services import UserService
...
class TestClientService:
    ...
    def test_create_client_success(self):
        ...
        with patch("services.client_services.utils.is_valid_email",
                   mock_is_valid_email):
...
class TestDepartementService:
    ...
    def test_get_departement_id_case_insensitive(self, monkeypatch):
        ...
        monkeypatch.setattr(
            "services.departement_services.departement_dao."
            "get_all_departements",
            mock_get_all_departements)
...
class TestAuthService:
    ...
    def test_password_verification(self):
        ...
        with patch("argon2.PasswordHasher.verify") as mock_verify:
            ...
            success, token, message = service.login(
                Mock(), "testuser", "wrongpass")
            assert success is False
